...
Page({
  ...
  getFilter: function () {
    ...
    //   this.setData({
    //     priceList: res.data.data.house_price,
    //     typeList: res.data.data.house_style
    //   })
    // });
    if (!!app.globalData.filterData) {
      this.setData({
        priceList: app.globalData.filterData.data.house_price,
  ...
  getList(page) {
    ...
    app.getList(page, {
      ...
      fang_price: this.data.priceid == 1 ? '' : this.data.priceid,
      page:page,
